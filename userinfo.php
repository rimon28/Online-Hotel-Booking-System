...
<tr>
    ...
    <td width="380"><input type="text" name="username" required/></td>
  </tr>
  <tr>
    <td><span class="style1"><strong>Enter password:</strong></span></td>
    <td><input type="password" name="pwd" maxlength="8" pattern=".{6,}" title="Six or more characters" required/></td>
  </tr>
  <tr>
	...
	<tr>
		...
		<td colspan=4><input type=text name=txtname size=50 required></td>
	</tr>
	<tr>
		<th align=left>Email   :</th>
		<td colspan=4><input type="text" name="txtemail" size=50 required title="Contact's email (format: xxx@xxx.xxx)" pattern="[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~.-]+@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan=4><input type="text" name="txtnumber" size=15 required pattern="[0]{1}[0-9]{10}" title="Phone number with 0 and remaing 10 digit with 0-9"></td>
	</tr>
	<tr>
		<th align=left valign=top>Address   :</th>
		<td colspan=4><textarea name=txtaddress rows=5 cols=40 required></textarea></td>
	</tr>
</table>
<br />
